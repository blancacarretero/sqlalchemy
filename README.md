...
* Plot the results by using the DataFrame `plot` method, as shown in the following image:
  ...
  <img src="https://github.com/blancacarretero/sqlalchemy/blob/main/images/Precipitation.png?raw=true"  width="500">
...
* Design a query to retrieve the previous 12 months of temperature observation data (TOBS).
    ...
    * Plot the results as a histogram with `bins=12`, as shown in the following image:
    ...
    <img src="https://github.com/blancacarretero/sqlalchemy/blob/main/images/station-histogram.png?raw=true"  width="500">
